...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DocumentReference reference  = db.collection("FirebaseAuthUsers").document(user.getUid());
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException error) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    username.setText(users.getFullname());
                            ...
                            Glide.with(getContext()).load(users.getImgurl()).into(imageView);
                        }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            FirebaseFirestore db = FirebaseFirestore.getInstance();
                            DocumentReference userRef = db.collection("FirebaseAuthUsers").document(user.getUid());
                            ...
                            userRef.update(updates)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Log.d(TAG, "User's imageURL updated in Firestore");
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Log.w(TAG, "Error updating user's imageURL in Firestore", e);
                                        }
                                    });
